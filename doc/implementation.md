...
#### 【x】1-1. IndexedDB（Dexie.js）セットアップ（2時間）
- **Red**: データベース初期化テスト作成
  ```typescript
...
#### 【x】7-1. ImageDetailModalコンポーネント（2時間）
- **Red**: モーダル表示テスト
- **Green**: 詳細表示、メモ編集UI実装
- **Refactor**: アクセシビリティ対応
...
#### 【x】10-1. 画像アップロードシナリオ（1時間）
- **Red**: E2Eテスト作成（失敗）
- **Green**: テストパスまで実装調整
- **Refactor**: テストコード整理

#### 【x】10-2. タグ管理・検索シナリオ（1時間）
- **Red**: E2Eテスト作成
- **Green**: テストパス確認
- **Refactor**: アサーション強化

#### 【x】10-3. スライドショーシナリオ（1時間）
- **Red**: E2Eテスト作成
- **Green**: テストパス確認
- **Refactor**: エッジケース追加
